...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	//       * Вид - Строка - Вид внешнего объекта. Соответствует реквизиту "Вид" (ПеречислениеСсылка.ВидыДополнительныхОтчетовИОбработки). 
...
Функция ПолучитьТекущиеПредставленияПользователей(ИсторическиеЗначения)
	...
	Для Каждого ОписаниеПользователяИБ Из ОписанияПользователейИБ Цикл
		...
		ПользовательПриложения = Пользователи.НайтиПоИдентификатору(
			ОписаниеПользователяИБ.УникальныйИдентификатор);
		
		Если ЗначениеЗаполнено(ПользовательПриложения) Тогда
			ПредставлениеПользователя = ИмяПользователяИБ + "; " + Строка(ПользовательПриложения);
...
Процедура ДобавитьИсходныеПредставленияПользователя(
	Значения,
	ДобавленныеПредставления,
	ИсторическиеЗначения,
	ИмяПользователяИБ)
