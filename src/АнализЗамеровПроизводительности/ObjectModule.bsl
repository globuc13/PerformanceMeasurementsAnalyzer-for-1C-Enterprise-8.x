...
Процедура ПриОпределенииПараметровВыбора(Форма, СвойстваНастройки) Экспорт
	...
	СвойстваНастройки.ЗначенияДляВыбора = РезультатПолучения.Значения;
...
//  Структура:
//   * Доступен - Булево - удалось получить список пользователей ИБ;
//   * Значения - СписокЗначений - значения для стандартного отбора СКД;
//   * ТекстОшибки - Строка - описание ошибки доступа.
Функция ПолучитьТекущиеПредставленияПользователей()
	...
	Для Каждого ОписаниеПользователяИБ Из ОписанияПользователейИБ Цикл
		...
		Иначе
			ПредставлениеПользователя = ИмяПользователяИБ;
		КонецЕсли;
		
		Если ДобавленныеПредставления.Получить(ПредставлениеПользователя) = Неопределено Тогда
			Результат.Значения.Добавить(ПредставлениеПользователя, ПредставлениеПользователя);
